              ...
              children: [
                if (responsiveVisibility(
                  ...
                  Container(
                    ...
                    child: Lottie.asset(
                      'assets/lottie_animations/PurpleTrain.json',
                      width: 150.0,
                      height: 130.0,
                      fit: BoxFit.cover,
                      animate: true,
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            20.0, 40.0, 20.0, 0.0),
                                        child: Text(
                                          'Each tale is brought to life with vivid illustrations, engaging narration and thoughtful stories.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  75.0, 40.0, 75.0, 0.0),
                                          child: Text(
                                            'Each tale is brought to life with ',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            20.0, 25.0, 20.0, 0.0),
                                        child: Text(
                                          'Perfect for teaching young readers or for a cozy bedtime tale.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  75.0, 55.0, 75.0, 60.0),
                                          child: Text(
                                            'Perfect for a cozy bedtime tale or teaching young listeners to read.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                      ...
                      child: Row(
                        ...
                        children: [
                          if (responsiveVisibility(
                            ...
                            Align(
                              alignment: const AlignmentDirectional(-0.09, 0.31),
